...
var wasmBinaryFile;
  wasmBinaryFile = 'transferDataFromJsToC++.wasm';
...
var ASM_CONSTS = {
  1780: function() {console.log("(1) I have been printed from inline JavaScript!"); console.log("I have no parameters and I do not return anything :(");},  
 1913: function($0) {console.log("(2) I have received a parameter! It is:", $0); console.log("Setting the background to that color index!"); set_background_color($0);},  
 2063: function($0, $1) {console.log("(3) I received two parameters! They are:", $0, $1); console.log("Let's return their sum!"); return sum($0, $1); function sum(a, b) { return a + b; }}
};
